...
import com.emprestimo.gestor.repository.FaseFacade;
...
public class FaseConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Fase) {
            Fase o = (Fase) object;
            return getStringKey(o.getIdfases());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Fase.class.getName()});
            return null;
        }
    }
